...
In order to support loading of multiple wallets in cobrax-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cobrax.cpp.
...
Changes to cobrax.cpp
-------------------

cobrax.cpp is the entry point into cobrax-qt, and as such, will require some minor modifications to provide hooks for
