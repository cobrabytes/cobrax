...
cobrax now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare <proposal-name> <url> <payment_count> <block_start> <cobrax_address> <monthly_payment_xmx>
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ CBRX, _12_ times over the course of a year totaling _24000_ CBRX.
...
mnbudget submit <proposal-name> <url> <payment_count> <block_start> <cobrax_address> <monthly_payment_xmx> <collateral_hash>
...
When block `1000000` is reached you'll receive a payment for `1200` CBRX.
 ...
 * vote-many          - Vote on a cobrax initiative
 * vote-alias         - Vote on a cobrax initiative
 * vote               - Vote on a cobrax initiative/budget
