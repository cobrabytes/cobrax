...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("cobrax Core cobrax-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cobrax-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cobrax transaction") + "\n" +
                               "  cobrax-tx [options] -create [commands]   " + _("Create hex-encoded cobrax transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cobrax transaction
