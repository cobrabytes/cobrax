...
/** Utility functions used by the cobrax Qt UI.
 */
namespace GUIUtil
{
...
// Render cobrax addresses in monospace font
...
// Parse "cobrax:" URI into recipient object, return true on successful parsing
