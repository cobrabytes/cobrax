...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a cobrax address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cobrax:URIs)"));
...
*/
    ...
    aboutAction = new QAction(QIcon(":/icons/info_menu"), tr("&About cobrax Core"), this);
    aboutAction->setStatusTip(tr("Show information about cobrax Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for cobrax"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your cobrax addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify_menu"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified cobrax addresses"));
    ...
    openAction->setStatusTip(tr("Open a cobrax:URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the cobrax Core help message to get a list with possible cobrax command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("cobrax Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to cobrax network", "", count));
}
...
{
    QString strTitle = tr("cobrax"); // default title
